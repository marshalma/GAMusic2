...
import fitnessfunction.MelodyFitnessStrategy;
import components.Scale;
import plugins.IntervalStrategy;
import plugins.ParallelIntervalStrategy;
import plugins.ScaleStrategy;
...
public final class MelodyFitnessFunctionBuilder {
    ...
    public MelodyFitnessFunctionBuilder addStrategy(MelodyFitnessStrategy melodyFitnessStrategy) {
        if (melodyFitnessStrategy == null) {
            throw new IllegalArgumentException("melodyFitnessStrategy is null");
        }

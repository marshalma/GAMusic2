...
import util.GeneNoteFactory;
import util.MidiDataOutputStream;
import util.MidiFileWriter;
import util.MidiGeneHelper;
...
public class MusicEngine {
    private static final Logger LOG = Logger.getLogger(MusicEngine.class);
